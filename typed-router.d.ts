...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-domain-add': RouteRecordInfo<'apps-domain-add', '/apps/domain/add', Record<never, never>, Record<never, never>>,
    'apps-domain-edit-id': RouteRecordInfo<'apps-domain-edit-id', '/apps/domain/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-domain-list': RouteRecordInfo<'apps-domain-list', '/apps/domain/list', Record<never, never>, Record<never, never>>,
    'apps-domain-view-id': RouteRecordInfo<'apps-domain-view-id', '/apps/domain/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'apps-keyword-add': RouteRecordInfo<'apps-keyword-add', '/apps/keyword/add', Record<never, never>, Record<never, never>>,
    ...
    'apps-report-backlink-view-id': RouteRecordInfo<'apps-report-backlink-view-id', '/apps/report/backlink/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-report-list': RouteRecordInfo<'apps-report-list', '/apps/report/list', Record<never, never>, Record<never, never>>,
    'apps-report-view-id': RouteRecordInfo<'apps-report-view-id', '/apps/report/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
