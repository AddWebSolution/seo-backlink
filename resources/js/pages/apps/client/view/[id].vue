          ...
          <VCol cols="12" md="8">
            ...
            <VRow>
              ...
              <VCol cols="12" sm="6" class="mb-3">
                ...
                <p class="text-body-1 font-weight-medium pl-6 mb-0">Client</p>
              </VCol>
            </VRow>

            <!-- Company Information -->
            <h3 class="text-subtitle-2 font-weight-semibold mb-2 mt-4">Company Information</h3>
            <VDivider class="mb-3" />
            ...
            <VRow>
              <VCol cols="12" sm="6" class="mb-3">
                ...
                <p class="text-body-1 font-weight-medium pl-6 mb-0">
                  {{ currentClient.company_name || 'N/A' }}
                </p>
              </VCol>

              <VCol cols="12" sm="4" class="mb-3">
                <div class="d-flex align-center mb-1">
                  <VIcon icon="tabler-briefcase" size="18" class="me-2 text-medium-emphasis" />
                  <span class="text-caption text-medium-emphasis font-weight-medium">Designation</span>
                </div>
                <p class="text-body-1 font-weight-medium pl-6 mb-0">
                  {{ currentClient.designation || 'N/A' }}
                </p>
              </VCol>
            </VRow>
          </VCol>
