      ...
      <VRow class="mb-8">
        <VCol cols="12" md="3">
          <VCard
            elevation="2"
            class="h-100"
            :color="getStatusColor(backlink.status)"
            variant="tonal"
          >
        ...
        <VCol cols="12" md="3">
          ...
          >
            <VCardText class="pa-6 text-center">
              ...
              >
                <VIcon
                  :icon="backlink.do_follow ? 'tabler-link' : 'tabler-link-off'"
                  size="28"
                />
              </VAvatar>
        ...
        <VCol cols="12" md="3">
          <VCard
            elevation="2"
            class="h-100"
            :color="backlink.is_broken ? 'error' : 'success'"
            variant="tonal"
          >
            <VCardText class="pa-6 text-center">
              <VAvatar
              ...
              >
                <VIcon
                  :icon="backlink.is_broken ? 'tabler-link-off' : 'tabler-link'"
                  size="28"
                />
              </VAvatar>
            ...
            <VCol cols="12" md="6">
              <div class="info-item mb-6">
                ...
                <div v-if="backlink.target_url" class="ml-7">
                  ...
                  >
                    <span
                      class="text-body-1 me-2"
                      style="word-break: break-all"
                      >{{ backlink.target_url }}</span
                    >
              ...
              <div class="info-item mb-6">
                ...
                <div v-if="backlink.url" class="ml-7">
                  <a
                    :href="backlink.url"
                    target="_blank"
                    class="text-info text-decoration-none d-flex align-center"
                  >
                    <span
                      class="text-body-1 me-2"
                      style="word-break: break-all"
          ...
          <VRow>
            <VCol cols="12" md="3">
              ...
              >
                ...
                <VProgressLinear
                  :model-value="backlink.domain_rank || 0"
                  max="100"
                  color="primary"
                  class="mt-3"
                />
            ...
            <VCol cols="12" md="3">
              ...
              >
                ...
                <VProgressLinear
                  :model-value="backlink.spam_score || 0"
                  max="100"
                  color="warning"
                  class="mt-3"
                />
            ...
            <VCol cols="12" md="6">
              ...
              <div class="info-card pa-4 rounded border">
                ...
                <div v-if="backlink.key_highlights">
                  <VChip
                    v-for="highlight in getKeyHighlights(
