    ...
    <VCard class="mb-8 overflow-hidden" elevation="2" color="grey lighten-4">
      <VCardText class="pa-8">
        <VRow align="start" justify="space-between">
          ...
          <VCol cols="12" md="8">
            <VBtn color="primary" variant="outlined" class="text-primary mb-6"
              :to="{ name: 'apps-report-view', params: { id: backlink.report_id } }">
          ...
          <VCol cols="12" md="4" class="d-flex justify-end">
            <div class="d-flex gap-2">
              <VBtn color="primary" variant="outlined" @click="isEditDrawerOpen = true">
                <VIcon icon="tabler-edit" class="me-2" />
                Edit
              </VBtn>
              <VBtn color="error" variant="outlined" @click="showDeleteDialog = true">
          ...
          <VRow>
            <VCol cols="12" md="6">
              <div class="info-item mb-6">
                ...
                <p v-else class="text-body-1 text-medium-emphasis mb-0 ml-7">Not specified</p>
              </div>
            ...
            <VCol cols="12" md="6">
              <div class="info-item mb-6">
                ...
                <p class="text-body-1 mb-0 ml-7">{{ backlink.domain || 'Not specified' }}</p>
              </div>
              ...
              <div class="info-item mb-6">
                ...
                <p class="text-body-1 mb-0 ml-7">{{ backlink.from_domain || 'Not specified' }}</p>
              </div>
              ...
              <div class="info-item mb-6">
                ...
                <p class="text-body-1 mb-0 ml-7" style="word-break: break-word;">{{ backlink.page_title ||
                  'Not specified' }}</p>
              </div>
            </VCol>
          </VRow>
          ...
          <VRow>
            ...
            <VCol cols="12" md="3">
              <VCard variant="tonal" color="info" class="pa-6 text-center h-100">
                ...
                <p class="text-body-2 text-medium-emphasis mb-2">Quality Score</p>
            ...
            <VCol cols="12" md="6">
              ...
              <div class="info-card pa-4 rounded border">
                ...
                <div v-if="backlink.key_highlights">
                  <VChip v-for="highlight in getKeyHighlights(backlink.key_highlights)" :key="highlight" color="primary"
                    variant="outlined" size="small" class="me-2 mb-2">
                    {{ highlight }}
                  </VChip>
                </div>
                <p v-else class="text-body-1 text-medium-emphasis mb-0">No key highlights</p>
              </div>
            </VCol>
          </VRow>
        </VCardText>
    ...
    <VCard v-else elevation="2" class="mb-6">
      <VCardText class="text-center py-16">
        ...
        <p class="text-body-1 text-medium-emphasis mb-6 max-width-400 mx-auto">
          The backlink you're looking for doesn't exist or may have been deleted.
