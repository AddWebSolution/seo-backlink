...
const currentDomain = computed(() => {
  form.value.client_domain_id = clientDomainId.value
  return domainList.value.find(c => c.id == clientDomainId.value) || null
})
          ...
          <div v-show="state.expandedSections[0]">
            ...
            <VCardText class="pa-6">
              <VRow>
                ...
                <VCol cols="12" md="3">
                  <AppTextField label="Client Domain Name *" :value="currentDomain?.title" variant="outlined" readonly />
                </VCol>
